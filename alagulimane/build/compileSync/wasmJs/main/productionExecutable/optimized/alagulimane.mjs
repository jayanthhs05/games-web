...
import { importObject, setWasmExports } from './alagulimane.import-object.mjs'
...
const wasmFilePath = './alagulimane.wasm';
...
try {
  ...
  if (isBrowser) {
    wasmInstance = (await WebAssembly.instantiateStreaming(fetch(new URL('./alagulimane.wasm',import.meta.url).href), importObject, wasmOptions)).instance;
  }
} catch (e) {
